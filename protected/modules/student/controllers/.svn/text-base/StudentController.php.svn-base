...
class StudentController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'student'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
		...
		{
			$emsUser = new EmsUser();
			$_POST['User']['RoleId'] = Yii::app()->params['constants']['roles']['STUDENT'];
			$userData = $_POST['User'];
			
			$userId = $emsUser->saveUser($userData);
			if($userId)
			{
				...
				if($student->save())
				{
					...
					$studentDetails->attributes = $_POST['Studentdetails'];
