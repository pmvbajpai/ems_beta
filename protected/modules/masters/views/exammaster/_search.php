...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'ExamStartDate'); ?>
		<?php echo $form->textField($model,'ExamStartDate'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'ExamEndDate'); ?>
		<?php echo $form->textField($model,'ExamEndDate'); ?>
	</div>
