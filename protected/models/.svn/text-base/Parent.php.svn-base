...
class Parent extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'PermaAddress1' => 'Permanent Address1',
			'PermaAddress2' => 'Permanent Address2',
			'PermaSuburbId' => 'Permanent Suburb',
			'PermaCityId' => 'Permanent City',
			'PermaStateId' => 'Permanent State',
			'PermaCountryId' => 'Permanent Country',
			'PermaZipcode' => 'Permanent Zipcode',
			'Mobile1' => 'Mobile1',
			'Mobile2' => 'Mobile2',
			'Phone1' => 'Phone1',
			'Phone2' => 'Phone2',
